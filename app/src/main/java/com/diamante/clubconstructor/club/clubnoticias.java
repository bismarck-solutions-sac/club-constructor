...
public class clubnoticias extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clubnoticias);
    ...
    private void loadData() {
        ...
        try {
            ...
            Call<ResponseData> result = methodWS.getnoticiasList();
                ...
                public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                    if (response.isSuccessful()) {
                        ...
                        if (request.getCodigoError() == 0) {
                            adapter = new NoticiasListAdapter(context, request.noticias_list);
