...
public class ManualesListAdapter extends RecyclerView.Adapter<ManualesListAdapter.ViewHolder>{
    private Context context;
    private List<Manual> manuals;
    private String rootImage;
    private PromocionListAdapter adapter;

    public ManualesListAdapter(Context context, List<Manual> manuals){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        try {
            View ItemView = null;
            ItemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.items_manual_list, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        try{
            String path = rootImage + manuals.get(position).getPdf();

            holder.name.setText(manuals.get(position).name);
