...
public class JobsPublicationListAdapter extends RecyclerView.Adapter<JobsPublicationListAdapter.ViewHolder>{
    private Context context;
    private List<JobsPublication> jobs;
    private String rootImage;
    private PromocionListAdapter adapter;

    public JobsPublicationListAdapter(Context context, List<JobsPublication> jobs){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        try {
            View ItemView = null;
            ItemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.items_jobspublication_list, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        try{
            ...
            holder.name.setText(jobs.get(position).name);
            holder.phone.setText("Celular: " + jobs.get(position).mobilphone);
            holder.admin.setText("Administrador: " + jobs.get(position).admin);
        }catch (Exception e){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private TextView name, phone, admin;
        public ViewHolder(View Item){
            ...
            try {
                ...
                admin       = Item.findViewById(R.id.admin);
            }catch (Exception e){
