...
public class NoticiasListAdapter extends RecyclerView.Adapter<NoticiasListAdapter.ViewHolder>{
    ...
    private List<Noticias> jobs;
    private String rootImage;
    private PromocionListAdapter adapter;

    public NoticiasListAdapter(Context context, List<Noticias> jobs){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        try {
            View ItemView = null;
            ItemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.items_noticias_list, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        try{
            ...
            holder.header.setText(jobs.get(position).header);
        }catch (Exception e){
